    ...
    <div class="container mx-auto mt-4 flex justify-center">
        <div class="w-full">
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-xl mb-4">Image Gallery for Author: {{ $author->name }}</h2>
                </div>
                <div class="flex text-right">
                    <a href="{{ route('authors.index') }}" class="flex" title="back to Authors list">
                        ...
                        <div class="mt-1 pt-1 text-sm">Back to Authors List</div>
                    </a>
                </div>
            </div>
