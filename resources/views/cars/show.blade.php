    ...
    <div class="container mx-auto mt-4 flex justify-center">
        <div class="w-full">
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-xl mb-4">Image Gallery for Car: {{ $car->model }}</h2>
                </div>
                <div class="flex text-right">
                    <a href="{{ route('cars.index') }}" class="flex" title="back to car list">
                        ...
                        <div class="mt-1 pt-1 text-sm">Back to Car List</div>
                    </a>
                </div>
            </div>
